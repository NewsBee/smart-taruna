...
const HomeFeature: FC = () => {
  return (
    <Box
      id="feature"
      sx={{ pb: { xs: 10, md: 14 }, backgroundColor: "background.paper" }}
    >
      <Container>
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: "relative" }}>
              ...
              >
                ...
                >
                  <Typography sx={{ fontWeight: 600, lineHeight: 1 }}>Siap ujian</Typography>
          ...
          <Grid item xs={12} md={7}>
            ...
            >
              Tryout Smarttaruna hadir untuk solusi kamu untuk mempersiapkan
              diri menghadapi tes SKD kedinasan/cpns, kami menghadirkan
